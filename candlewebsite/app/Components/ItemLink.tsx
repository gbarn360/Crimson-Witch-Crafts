    ...
    return (
        <div>
            ...
            {hovered && subCategories ?
                <div onMouseOver={() => setHovered(true)} onMouseLeave={() => setHovered(false)} className="left-0 right-0 flex justify-center gap-5 bg-gray-300 text-gray-900 p-2 text-xs xl:text-sm z-30 absolute rounded-sm">
